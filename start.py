...
if __name__ == "__main__":
    ...
    t3 = threading.Thread(target=run_command, args=(["gunicorn", "--access-logfile", "-", "--error-logfile", "-", "-w", "10", "-k", "eventlet", "-b", "0.0.0.0:5000", "app:app", "--env", "FLASK_SECRET_KEY=B5FYETKek4TxfdOUzR_pG1VIfwhRS_OM_wruhP5kOrY"],))
    t3.start()
    time.sleep(2)
